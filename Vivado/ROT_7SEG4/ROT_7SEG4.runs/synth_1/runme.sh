...
HD_PWD='/home/udagawa/projects/Vivado/ROT_7SEG4/ROT_7SEG4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROT_7SEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROT_7SEG.tcl
