...
HD_PWD='/home/udagawa/projects/Vivado/ROT_7SEG4/ROT_7SEG4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ROT_7SEG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROT_7SEG.tcl -notrace
