...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/COUNT4/COUNT4.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log COUNT4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNT4.tcl
