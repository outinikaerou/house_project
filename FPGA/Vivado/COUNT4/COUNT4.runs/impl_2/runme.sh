...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/COUNT4/COUNT4.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log COUNT4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COUNT4.tcl -notrace
