...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/UPDOWN_7SEG/UPDOWN_7SEG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UPDOWN_7SEG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UPDOWN_7SEG.tcl -notrace
