...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/UPDOWN_7SEG/UPDOWN_7SEG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UPDOWN_7SEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UPDOWN_7SEG.tcl
