...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/COUNT4_2/COUNT4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNT4_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COUNT4_2.tcl -notrace
