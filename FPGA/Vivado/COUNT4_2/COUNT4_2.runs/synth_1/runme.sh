...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/COUNT4_2/COUNT4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNT4_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNT4_2.tcl
