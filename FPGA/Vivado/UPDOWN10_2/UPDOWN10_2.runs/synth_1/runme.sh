...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/UPDOWN10_2/UPDOWN10_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UPDOWN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UPDOWN.tcl
