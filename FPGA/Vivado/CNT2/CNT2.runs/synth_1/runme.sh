...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/CNT2/CNT2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLOCK_GEN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLOCK_GEN.tcl
