...
HD_PWD='/home/udagawa/projects/FPGA/Vivado/CNT2/CNT2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLOCK_GEN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLOCK_GEN.tcl -notrace
